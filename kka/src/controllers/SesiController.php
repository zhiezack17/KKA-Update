...
class SesiController {
    ...
    public function create(): void {
        ...
        $sharedIds = [];
        $canShare  = true;
        view('sesi/create', compact('desa','bidang','auditors','sharedIds','canShare'));
    }
    ...
    public function edit(): void {
        ...
        view('sesi/edit', compact('sesi','desa','bidang','subBidang','auditors','sharedIds','canShare'));
    }
